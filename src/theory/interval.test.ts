...
describe.each([
  [ 'g3', 12, { root: pc.parse('g'), intervals: [ P(1), M(2), M(3), P(4), P(5), M(6), M(7) ] }, [ 0, 2, 4, 5, 7, 9, 11, 12 ]],
  [ 'a3', 12, { root: pc.parse('bb'), intervals: [ P(1), M(2), M(3), P(4), P(5), M(6), M(7) ] }, [ 0, 1, 3, 5, 6, 8, 10, 12 ]]
