...
export const PitchClassPicker: React.FC<{
  value: PitchClass
  ...
  return (
    <div className='PitchClassPicker'>
      <Dropdown
        value={value.letter}
        options={NoteLetters.map((n) => ({ value: n, label: NoteLetter[n] }))}
        onChange={handleLetterChange}
      />
      <Dropdown
        value={String(value.accidental)}
        options={Accidentals.map((a) => ({
          value: String(a),
          label: accidental.format(a),
        }))}
